...
<link rel="canonical" href="https://kamakura-guesthouse.com/stay/" />
<link rel='shortlink' href='https://kamakura-guesthouse.com/?p=14' />
<link rel="alternate" type="application/json+oembed" href="https://kamakura-guesthouse.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fkamakura-guesthouse.com%2Fstay%2F" />
<link rel="alternate" type="text/xml+oembed" href="https://kamakura-guesthouse.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fkamakura-guesthouse.com%2Fstay%2F&#038;format=xml" />
...
<body class="page-template-default page page-id-14 page-stay">
<?php
...
<p class="main_copy"><?php echo $title; ?></p>
<p class="main_lead"><?php echo $text; ?></p>

<div class="check_time">
	<?php echo $checkInOuttime; ?>
</div>
...
<h2 class="ttl"><?php echo $room1name; ?></h2>
<p class="txt"><?php echo $room1text; ?></p>
<div class="spec">
<div class="table">
<?php echo $room1about; ?>
</div>　
...
<h2 class="ttl"><?php echo $room2name; ?></h2>
<p class="txt"><?php echo $room2text; ?></p>
<div class="spec">
<div class="table">
	<?php echo $room2about; ?>	
</div>　
...
<div class="colR wrap_txt">
<h2 class="ttl"><?php echo $room3name; ?></h2>
<p class="txt"><?php echo $room3text; ?></p>
<div class="spec">
<div class="table">
	<?php echo $room2about; ?>	
</div>　
...
<section id="chui" class="information">
<h2 class="ttl">ご注意事項</h2>
<ul>
<?php echo $attention; ?>
</ul>
</section>
...
<div class="uinfo">
<p><?php echo $subText1; ?></p>
<p class="btn nohover"><a href="/facility">施設案内はこちらから<span class="arrow_w"></span></a></p>
</div>
